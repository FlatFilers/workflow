...
/**
 * `simpleSpaceSetup` is a higher-order function that creates a plugin to configure a
 ...
 */
export function simpleSpaceSetup(setup: SetupFactory) {
...
// Defining types used in the simpleSpaceSetup function
